...
public class DriveConstants {
     ...
     * empirically tuned.
     */
    //public static double kV = 1.0 / rpmToVelocity(MAX_RPM); // originally equal to 0.00878702239292728
    public static double kV = 0.0155555; // originally equal to 0.00878702239292728
